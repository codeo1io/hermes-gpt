...
- id: `rm-033` | track: reliability | priority: 105.0 | status: implemented (rm-033a slice landed 2026-09-23 at integration f7a1646564b14754962d030251e6caef: pyproject `pyyaml>=6.0.3,<7` — flooring the #17 `>=6,<7` bound — plus the CHANGELOG CVE-2026-31132 entry; requirements*.txt deletion + PR #19 landing + upstream PR #75 rebase remain open at the gate)
