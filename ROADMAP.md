...
- id: `rm-041` | track: correctness | priority: 38.0 | status: candidate (orig rm-028 in run-684b9786 numbering)
...
- id: `rm-027` | track: reliability | priority: 62.0 | status: implemented (landed via #16 5bfd8ea67c; pyproject.toml:2 setuptools>=77 re-verified at integration 0bcfd799f38c 2026-09-23; originally validated via no-isolation prepare_metadata under 77.0.3 -> hermes_gpt-0.10.0.dist-info + LICENSE)
